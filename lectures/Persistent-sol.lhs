...
> -- no elements in the emptyset
> prop_myproperty :: forall s. (Set s) => Bool
> prop_myproperty = null (elements (empty :: s Int))

> -- insertion is idempotent
> prop_myproperty2 :: forall s. (Set s) => Int -> s Int -> Bool
> prop_myproperty2 x s = l1 == l2
>   where l1 = elements $ insert x s
>         l2 = elements $ insert x (insert x s) 
