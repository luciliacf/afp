---
title: "Type-directed Property Testing"
date: October 2, 2017
---

[QListLHS]: QuickList.lhs
[QList-sol]: QuickList-sol.html

*Note*: You should download the [lhs version][QListLHS] of this module and replace all parts marked undefined.
A solution to this exercise will eventually be available [here][QList-sol]
...
bugs in [telecommunications code][4]. In 2010, it received the
...
Ugh! So close, and yet $\cdots$ Can you spot the bug in our code?
...
The QC library defines a type `Gen a` of  \"generators for values of type a\".
