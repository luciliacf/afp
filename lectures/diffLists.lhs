...
[DlistLHS]: diffLists.lhs
[diffLists-sol]: diffLists-sol.html

*Note*: You should download the [lhs version][DListLHS] of this module and replace all parts marked undefined.
A solution to this exercise will eventually be available [here][diffLists-sol]
