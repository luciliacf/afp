---
title: Exercise: SecretCode
date: September 13, 2017
---

[secretCodeLHS]: secretCode.lhs
[secretCode-sol]: secretCode-sol.html

Note: this is the stubbed version of module SecretCode. You should download the
[lhs version][secretCodeLHS] of this module and replace all parts marked undefined.

A solution to this exercise will eventually be available [here][secretCode-sol]
...
Ignoring the `Eq a` part for now (we\'ll talk about it next lecture), this
